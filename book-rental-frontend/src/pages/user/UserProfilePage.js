...
const UserProfilePage = () => {
    ...
    const handlerEdit = (e) => {
        e.preventDefault();
        updateUserData("user/edituser", editUserProfile, jwtToken).then(res => {
            swal({
                text: res.data,
                icon: "success"
            }).then(() => {
                dispatch(usersActions.editUser(editUserProfile));
                history.push("/user/profile_user");
                history.go(0);
            });
        }).catch(err => {
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <div type="button" className="btn btn-danger" data-bs-dismiss="modal" onClick={(e) => handlerEdit(e)}>Yes</div>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-md-8 col-lg-9">
                                                    {bookImage.fileData !== null ?
                                                        ...
                                                        :
                                                        <>
                                                            <img style={{ height: "120px", width: "120px" }} src={Profile_Image} alt="Profile" />
                                                        </>
                                                    }
                                                    <div className="pt-2">
                                                        <div className="pt-2">
